...
class KefuTagmanagement(unittest.TestCase):
    def setUp(self):
    ...
    def test_kefu_tagmanagement(self):
        driver = self.driver
        ...
        driver.find_element_by_id("tag_name").send_keys(random.randint(0,99)+random.randint(0,99))
        driver.find_element_by_name("commit").click()
        driver.find_element_by_id("add_tag_1").click()
        driver.find_element_by_id("tag_name").clear()
        driver.find_element_by_id("tag_name").send_keys(u"我的iaoqian")
        driver.find_element_by_name("commit").click()
        driver.find_element_by_id("add_tag").click()
        driver.find_element_by_id("tag_name").clear()
        driver.find_element_by_id("tag_name").send_keys(random.randint(0,99))
        driver.find_element_by_name("commit").click()
        #self.assertTrue(u"客服系统", driver.title)
        print driver.title
