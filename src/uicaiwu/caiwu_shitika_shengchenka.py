...
class CaiwuShitikaShengchenka(unittest.TestCase):
    def setUp(self):
    ...
    def test_caiwu_shitika_shengchenka(self):
        driver = self.driver
        ...
        driver.find_element_by_id("rcard_list_form_title").send_keys("sassasa1111")
