...
class WuiuCityListDiaodupaidan(unittest.TestCase):
    def setUp(self):
    ...
    def test_wuiu_citylist_diaodupaidan(self):
        driver = self.driver
        ...
        time.sleep(1)
        driver.find_element_by_link_text(u"调度派单").click()
        time.sleep(1)
        driver.find_element_by_id("order_search_form_ordersn").click()
