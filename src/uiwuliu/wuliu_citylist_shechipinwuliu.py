...
class WuiuCitylistShechipinwuliu(unittest.TestCase):
    def setUp(self):
    ...
    def test_wuiu_citylist_shechipinwuliu(self):
        driver = self.driver
        ...
        driver.find_element_by_id("courier_form_realname").send_keys(u"奢侈品"+verification_code)
        ...
        driver.find_element_by_id("courier_form_id_number").send_keys("152829292201191")
        ...
        driver.find_element_by_id("courier_form_bank_card").send_keys("622571127222423")
        ...
        driver.find_element_by_id("realname").send_keys("qqq")
        driver.find_element_by_name("commit").click()
        time.sleep(2)
        driver.find_element_by_link_text(u"编辑").click()
        driver.find_element_by_id("courier_form_realname").clear()
        driver.find_element_by_id("courier_form_realname").send_keys("qqqqsqwqwq222")
        driver.find_element_by_name("commit").click()
        time.sleep(1)
